...
proc create_root_design { parentCell } {
  ...
  # Create instance: adc0_clk_conv_im, and set properties
  set adc0_clk_conv_im [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_clock_converter:1.1 adc0_clk_conv_im ]

  # Create instance: adc0_clk_conv_re, and set properties
  set adc0_clk_conv_re [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_clock_converter:1.1 adc0_clk_conv_re ]

  # Create instance: adc0_dma_im, and set properties
  set adc0_dma_im [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 adc0_dma_im ]
  set_property -dict [ list \
  ...
  # Create instance: adc0_dma_re, and set properties
  set adc0_dma_re [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 adc0_dma_re ]
  set_property -dict [ list \
   CONFIG.c_addr_width {64} \
   CONFIG.c_include_mm2s {0} \
  ...
  # Create instance: adc0_fifo_im, and set properties
  set adc0_fifo_im [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 adc0_fifo_im ]
  set_property -dict [ list \
   CONFIG.FIFO_MODE {2} \
 ] $adc0_fifo_im

  # Create instance: adc0_fifo_re, and set properties
  set adc0_fifo_re [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 adc0_fifo_re ]
  set_property -dict [ list \
   CONFIG.FIFO_MODE {2} \
 ] $adc0_fifo_re

  # Create instance: adc0_sys_reset, and set properties
  set adc0_sys_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 adc0_sys_reset ]
  ...
  connect_bd_intf_net -intf_net adc0_dma_im_M_AXI_S2MM [get_bd_intf_pins adc0_dma_im/M_AXI_S2MM] [get_bd_intf_pins axi_interconnect_0/S01_AXI]
  connect_bd_intf_net -intf_net adc0_dma_re_M_AXI_S2MM [get_bd_intf_pins adc0_dma_re/M_AXI_S2MM] [get_bd_intf_pins axi_interconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net axi_hpm0_fpd_M01_AXI [get_bd_intf_pins adc0_dma_im/S_AXI_LITE] [get_bd_intf_pins axi_hpm0_fpd/M01_AXI]
  connect_bd_intf_net -intf_net axi_hpm0_fpd_M02_AXI [get_bd_intf_pins adc0_dma_re/S_AXI_LITE] [get_bd_intf_pins axi_hpm0_fpd/M02_AXI]
  ...
  connect_bd_intf_net -intf_net axi_hpm1_fpd_M01_AXI [get_bd_intf_pins axi_hpm1_fpd/M01_AXI] [get_bd_intf_pins rfdc/s_axi]
  ...
  connect_bd_intf_net -intf_net axis_clock_converter_0_M_AXIS [get_bd_intf_pins adc0_clk_conv_im/M_AXIS] [get_bd_intf_pins adc0_fifo_im/S_AXIS]
  connect_bd_intf_net -intf_net axis_clock_converter_1_M_AXIS [get_bd_intf_pins adc0_clk_conv_re/M_AXIS] [get_bd_intf_pins adc0_fifo_re/S_AXIS]
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins adc0_dma_re/S_AXIS_S2MM] [get_bd_intf_pins adc0_fifo_im/M_AXIS]
  connect_bd_intf_net -intf_net axis_data_fifo_1_M_AXIS [get_bd_intf_pins adc0_dma_im/S_AXIS_S2MM] [get_bd_intf_pins adc0_fifo_re/M_AXIS]
  ...
  connect_bd_net -net adc0_dma_im_s2mm_introut [get_bd_pins adc0_dma_im/s2mm_introut] [get_bd_pins concat_irq/In1]
  connect_bd_net -net adc0_dma_re_s2mm_introut [get_bd_pins adc0_dma_re/s2mm_introut] [get_bd_pins concat_irq/In0]
  connect_bd_net -net adc0_sys_reset_peripheral_aresetn [get_bd_pins adc0_clk_conv_im/s_axis_aresetn] [get_bd_pins adc0_clk_conv_re/s_axis_aresetn] [get_bd_pins adc0_sys_reset/peripheral_aresetn] [get_bd_pins axi_clk_conv_0/m_axi_aresetn]
  ...
  connect_bd_net -net concat_irq_dout [get_bd_pins axi_intc_concat/In1] [get_bd_pins concat_irq/dout]
  ...
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins axi_clk_conv_0/s_axi_aresetn] [get_bd_pins axi_hpm0_lpd/ARESETN] [get_bd_pins axi_hpm1_fpd/ARESETN] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins adc0_clk_conv_im/m_axis_aresetn] [get_bd_pins adc0_clk_conv_re/m_axis_aresetn] [get_bd_pins adc0_dma_im/axi_resetn] [get_bd_pins adc0_dma_re/axi_resetn] [get_bd_pins adc0_fifo_im/s_axis_aresetn] [get_bd_pins adc0_fifo_re/s_axis_aresetn] [get_bd_pins adc0_sys_reset/aux_reset_in] [get_bd_pins axi_hpm0_fpd/ARESETN] [get_bd_pins axi_hpm0_fpd/M01_ARESETN] [get_bd_pins axi_hpm0_fpd/M02_ARESETN] [get_bd_pins axi_hpm0_fpd/S00_ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  connect_bd_net -net rfdc_clk_adc0 [get_bd_pins adc0_clk_conv_im/s_axis_aclk] [get_bd_pins adc0_clk_conv_re/s_axis_aclk] [get_bd_pins adc0_sys_reset/slowest_sync_clk] [get_bd_pins axi_clk_conv_0/m_axi_aclk] [get_bd_pins rfdc/clk_adc0] [get_bd_pins rfdc/m0_axis_aclk]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins adc0_sys_reset/ext_reset_in] [get_bd_pins axi_hpm0_lpd/M00_ARESETN] [get_bd_pins axi_hpm0_lpd/M01_ARESETN] [get_bd_pins axi_hpm0_lpd/M02_ARESETN] [get_bd_pins axi_hpm0_lpd/M03_ARESETN] [get_bd_pins axi_hpm0_lpd/M04_ARESETN] [get_bd_pins axi_hpm0_lpd/M05_ARESETN] [get_bd_pins axi_hpm0_lpd/M06_ARESETN] [get_bd_pins axi_hpm0_lpd/M07_ARESETN] [get_bd_pins axi_hpm0_lpd/M08_ARESETN] [get_bd_pins axi_hpm0_lpd/M09_ARESETN] [get_bd_pins axi_hpm0_lpd/M10_ARESETN] [get_bd_pins axi_hpm0_lpd/S00_ARESETN] [get_bd_pins axi_hpm1_fpd/M00_ARESETN] [get_bd_pins axi_hpm1_fpd/M01_ARESETN] [get_bd_pins axi_hpm1_fpd/M02_ARESETN] [get_bd_pins axi_hpm1_fpd/M03_ARESETN] [get_bd_pins axi_hpm1_fpd/S00_ARESETN] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins binary_latch_counter_0/resetn] [get_bd_pins pin_control/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins rfdc/s_axi_aresetn] [get_bd_pins system_management_wiz_0/s_axi_aresetn] [get_bd_pins syzygy_std0/s_axi_aresetn]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_clk_conv_0/s_axi_aclk] [get_bd_pins axi_hpm0_lpd/ACLK] [get_bd_pins axi_hpm0_lpd/M00_ACLK] [get_bd_pins axi_hpm0_lpd/M01_ACLK] [get_bd_pins axi_hpm0_lpd/M02_ACLK] [get_bd_pins axi_hpm0_lpd/M03_ACLK] [get_bd_pins axi_hpm0_lpd/M04_ACLK] [get_bd_pins axi_hpm0_lpd/M05_ACLK] [get_bd_pins axi_hpm0_lpd/M06_ACLK] [get_bd_pins axi_hpm0_lpd/M07_ACLK] [get_bd_pins axi_hpm0_lpd/M08_ACLK] [get_bd_pins axi_hpm0_lpd/M09_ACLK] [get_bd_pins axi_hpm0_lpd/M10_ACLK] [get_bd_pins axi_hpm0_lpd/S00_ACLK] [get_bd_pins axi_hpm1_fpd/ACLK] [get_bd_pins axi_hpm1_fpd/M00_ACLK] [get_bd_pins axi_hpm1_fpd/M01_ACLK] [get_bd_pins axi_hpm1_fpd/M02_ACLK] [get_bd_pins axi_hpm1_fpd/M03_ACLK] [get_bd_pins axi_hpm1_fpd/S00_ACLK] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins binary_latch_counter_0/clk] [get_bd_pins pin_control/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins rfdc/s_axi_aclk] [get_bd_pins system_management_wiz_0/s_axi_aclk] [get_bd_pins syzygy_std0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_pins adc0_clk_conv_im/m_axis_aclk] [get_bd_pins adc0_clk_conv_re/m_axis_aclk] [get_bd_pins adc0_dma_im/m_axi_s2mm_aclk] [get_bd_pins adc0_dma_im/s_axi_lite_aclk] [get_bd_pins adc0_dma_re/m_axi_s2mm_aclk] [get_bd_pins adc0_dma_re/s_axi_lite_aclk] [get_bd_pins adc0_fifo_im/s_axis_aclk] [get_bd_pins adc0_fifo_re/s_axis_aclk] [get_bd_pins axi_hpm0_fpd/ACLK] [get_bd_pins axi_hpm0_fpd/M01_ACLK] [get_bd_pins axi_hpm0_fpd/M02_ACLK] [get_bd_pins axi_hpm0_fpd/S00_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk1] [get_bd_pins zynq_ultra_ps_e_0/saxihp2_fpd_aclk]
  ...
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces adc0_dma_im/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces adc0_dma_im/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces adc0_dma_re/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces adc0_dma_re/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs adc0_dma_im/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs adc0_dma_re/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0xB0080000 -range 0x00040000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs rfdc/s_axi/Reg] -force
  ...
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces adc0_dma_im/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_LPS_OCM]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces adc0_dma_re/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_LPS_OCM]
