...
user.org:user:AXI4_Stream_Synchonizer:1.0\
...
# Hierarchical cell: DAC_INTERLEAVE
proc create_hier_cell_DAC_INTERLEAVE_1 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_DAC_INTERLEAVE_1() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 S_AXIS_DAC_IM

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 S_AXIS_DAC_RE
  ...
  # Create instance: dac0_wconv_im, and set properties
  set dac0_wconv_im [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_dwidth_converter:1.1 dac0_wconv_im ]
  set_property -dict [ list \
   CONFIG.HAS_MI_TKEEP {1} \
   CONFIG.M_TDATA_NUM_BYTES {32} \
 ] $dac0_wconv_im

  # Create instance: dac0_wconv_re, and set properties
  set dac0_wconv_re [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_dwidth_converter:1.1 dac0_wconv_re ]
  set_property -dict [ list \
   CONFIG.HAS_MI_TKEEP {1} \
   CONFIG.M_TDATA_NUM_BYTES {32} \
 ] $dac0_wconv_re
  ...
  connect_bd_intf_net -intf_net S00_AXIS_DAC_IM_1 [get_bd_intf_pins S_AXIS_DAC_IM] [get_bd_intf_pins dac0_wconv_im/S_AXIS]
  connect_bd_intf_net -intf_net S00_AXIS_DAC_RE_1 [get_bd_intf_pins S_AXIS_DAC_RE] [get_bd_intf_pins dac0_wconv_re/S_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_dwidth_converter_0_M_AXIS [get_bd_intf_pins M00_AXIS] [get_bd_intf_pins axis_dwidth_converter_0/M_AXIS]
  connect_bd_intf_net -intf_net dac0_wconv_im_M_AXIS [get_bd_intf_pins axis_combiner_0/S01_AXIS] [get_bd_intf_pins dac0_wconv_im/M_AXIS]
  connect_bd_intf_net -intf_net dac0_wconv_re_M_AXIS [get_bd_intf_pins axis_combiner_0/S00_AXIS] [get_bd_intf_pins dac0_wconv_re/M_AXIS]

  # Create port connections
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins m_axi_aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins dac0_wconv_im/aresetn] [get_bd_pins dac0_wconv_re/aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_pins m_axi_aclk] [get_bd_pins axis_combiner_0/aclk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins dac0_wconv_im/aclk] [get_bd_pins dac0_wconv_re/aclk]
...
# Hierarchical cell: DAC_INTERLEAVE
proc create_hier_cell_DAC_INTERLEAVE { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_DAC_INTERLEAVE() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_channel_10 { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 M_AXIS_DAC_IM

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 M_AXIS_DAC_RE

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M_AXI_MM2S_IM

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M_AXI_MM2S_RE
  ...
  # Create pins
  create_bd_pin -dir I -type rst dac0_aresetn
  create_bd_pin -dir I -type clk dac0_clk
  create_bd_pin -dir O -from 1 -to 0 dac_irq
  create_bd_pin -dir I -type clk m_axi_aclk
  create_bd_pin -dir I -type rst m_axi_aresetn
  create_bd_pin -dir I -type clk s_axi_aclk
  create_bd_pin -dir I -type rst s_axi_aresetn

  # Create instance: AXI4_Stream_Synchoni_0, and set properties
  set AXI4_Stream_Synchoni_0 [ create_bd_cell -type ip -vlnv user.org:user:AXI4_Stream_Synchonizer:1.0 AXI4_Stream_Synchoni_0 ]

  # Create instance: DAC_INTERLEAVE
  create_hier_cell_DAC_INTERLEAVE_1 $hier_obj DAC_INTERLEAVE
  ...
  # Create instance: dac_source_switch, and set properties
  set dac_source_switch [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_switch:1.1 dac_source_switch ]
  set_property -dict [ list \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net AXI4_Stream_Synchoni_0_M00_AXIS [get_bd_intf_pins M_AXIS_DAC_RE] [get_bd_intf_pins AXI4_Stream_Synchoni_0/M00_AXIS]
  connect_bd_intf_net -intf_net AXI4_Stream_Synchoni_0_M01_AXIS [get_bd_intf_pins M_AXIS_DAC_IM] [get_bd_intf_pins AXI4_Stream_Synchoni_0/M01_AXIS]
  connect_bd_intf_net -intf_net DAC_INTERLEAVE_M00_AXIS [get_bd_intf_pins DAC_INTERLEAVE/M00_AXIS] [get_bd_intf_pins dac_source_switch/S01_AXIS]
  connect_bd_intf_net -intf_net S00_AXIS_DAC_IM_1 [get_bd_intf_pins S_AXIS_DAC_IM] [get_bd_intf_pins DAC_INTERLEAVE/S_AXIS_DAC_IM]
  connect_bd_intf_net -intf_net S00_AXIS_DAC_RE_1 [get_bd_intf_pins S_AXIS_DAC_RE] [get_bd_intf_pins DAC_INTERLEAVE/S_AXIS_DAC_RE]
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_pins S_AXI] [get_bd_intf_pins axi_interconnect/S00_AXI]
  connect_bd_intf_net -intf_net amplitude_controller_M_AXIS [get_bd_intf_pins amplitude_controller/M_AXIS] [get_bd_intf_pins dac_source_switch/S00_AXIS]
  connect_bd_intf_net -intf_net axi_dma1_M_AXI_MM2S [get_bd_intf_pins M_AXI_MM2S_IM] [get_bd_intf_pins axi_dma_im/M_AXI_MM2S]
  connect_bd_intf_net -intf_net axi_dma_M_AXI_MM2S [get_bd_intf_pins M_AXI_MM2S_RE] [get_bd_intf_pins axi_dma_re/M_AXI_MM2S]
  connect_bd_intf_net -intf_net axi_dma_im_M_AXIS_MM2S [get_bd_intf_pins AXI4_Stream_Synchoni_0/S01_AXIS] [get_bd_intf_pins axi_dma_im/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net axi_dma_re_M_AXIS_MM2S [get_bd_intf_pins AXI4_Stream_Synchoni_0/S00_AXIS] [get_bd_intf_pins axi_dma_re/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins amplitude_controller/S_AXI] [get_bd_intf_pins axi_interconnect/M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect/M01_AXI] [get_bd_intf_pins dac_source_switch/S_AXI_CTRL]
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins axi_dma_re/S_AXI_LITE] [get_bd_intf_pins axi_interconnect/M02_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_M03_AXI [get_bd_intf_pins axi_dma_im/S_AXI_LITE] [get_bd_intf_pins axi_interconnect/M03_AXI]
  connect_bd_intf_net -intf_net axis_clock_converter_4_M_AXIS [get_bd_intf_pins M_AXIS] [get_bd_intf_pins axis_clock_converter/M_AXIS]
  connect_bd_intf_net -intf_net dac0_source_switch_M00_AXIS [get_bd_intf_pins axis_clock_converter/S_AXIS] [get_bd_intf_pins dac_source_switch/M00_AXIS]

  # Create port connections
  connect_bd_net -net aclk_1 [get_bd_pins m_axi_aclk] [get_bd_pins AXI4_Stream_Synchoni_0/ACLK] [get_bd_pins DAC_INTERLEAVE/m_axi_aclk] [get_bd_pins amplitude_controller/aclk] [get_bd_pins axi_dma_im/m_axi_mm2s_aclk] [get_bd_pins axi_dma_re/m_axi_mm2s_aclk] [get_bd_pins axi_interconnect/ACLK] [get_bd_pins axi_interconnect/M00_ACLK] [get_bd_pins axi_interconnect/S00_ACLK] [get_bd_pins axis_clock_converter/s_axis_aclk] [get_bd_pins dac_source_switch/aclk]
  connect_bd_net -net aresetn_1 [get_bd_pins m_axi_aresetn] [get_bd_pins DAC_INTERLEAVE/m_axi_aresetn] [get_bd_pins amplitude_controller/aresetn] [get_bd_pins axi_interconnect/ARESETN] [get_bd_pins axi_interconnect/M00_ARESETN] [get_bd_pins axi_interconnect/S00_ARESETN] [get_bd_pins axis_clock_converter/s_axis_aresetn] [get_bd_pins dac_source_switch/aresetn]
  connect_bd_net -net axi_dma_im_mm2s_introut [get_bd_pins axi_dma_im/mm2s_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_dma_re_mm2s_introut [get_bd_pins axi_dma_re/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net dac0_aresetn_1 [get_bd_pins dac0_aresetn] [get_bd_pins axis_clock_converter/m_axis_aresetn]
  connect_bd_net -net dac0_clk_1 [get_bd_pins dac0_clk] [get_bd_pins axis_clock_converter/m_axis_aclk]
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins axi_dma_im/s_axi_lite_aclk] [get_bd_pins axi_dma_re/s_axi_lite_aclk] [get_bd_pins axi_interconnect/M01_ACLK] [get_bd_pins axi_interconnect/M02_ACLK] [get_bd_pins axi_interconnect/M03_ACLK] [get_bd_pins dac_source_switch/s_axi_ctrl_aclk]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins AXI4_Stream_Synchoni_0/ARESETN] [get_bd_pins axi_dma_im/axi_resetn] [get_bd_pins axi_dma_re/axi_resetn] [get_bd_pins axi_interconnect/M01_ARESETN] [get_bd_pins axi_interconnect/M02_ARESETN] [get_bd_pins axi_interconnect/M03_ARESETN] [get_bd_pins dac_source_switch/s_axi_ctrl_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins dac_irq] [get_bd_pins xlconcat_0/dout]
...
proc create_hier_cell_channel_00_1 { parentCell nameHier } {
  ...
  # Create instance: DAC_INTERLEAVE
  create_hier_cell_DAC_INTERLEAVE $hier_obj DAC_INTERLEAVE
  ...
  # Create instance: dac_irq_concat, and set properties
  set dac_irq_concat [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 dac_irq_concat ]
  ...
  connect_bd_net -net aclk_1 [get_bd_pins m_axi_aclk] [get_bd_pins AXI4_Stream_Synchoni_0/ACLK] [get_bd_pins DAC_INTERLEAVE/m_axi_aclk] [get_bd_pins amplitude_controller/aclk] [get_bd_pins axi_dma_im/m_axi_mm2s_aclk] [get_bd_pins axi_dma_re/m_axi_mm2s_aclk] [get_bd_pins axi_interconnect/ACLK] [get_bd_pins axi_interconnect/M00_ACLK] [get_bd_pins axi_interconnect/S00_ACLK] [get_bd_pins axis_clock_converter/s_axis_aclk] [get_bd_pins dac_source_switch/aclk]
  connect_bd_net -net aresetn_1 [get_bd_pins m_axi_aresetn] [get_bd_pins DAC_INTERLEAVE/m_axi_aresetn] [get_bd_pins amplitude_controller/aresetn] [get_bd_pins axi_interconnect/ARESETN] [get_bd_pins axi_interconnect/M00_ARESETN] [get_bd_pins axi_interconnect/S00_ARESETN] [get_bd_pins axis_clock_converter/s_axis_aresetn] [get_bd_pins dac_source_switch/aresetn]
  connect_bd_net -net axi_dma_im_mm2s_introut [get_bd_pins axi_dma_im/mm2s_introut] [get_bd_pins dac_irq_concat/In1]
  connect_bd_net -net axi_dma_re_mm2s_introut [get_bd_pins axi_dma_re/mm2s_introut] [get_bd_pins dac_irq_concat/In0]
  connect_bd_net -net dac0_aresetn_1 [get_bd_pins dac0_aresetn] [get_bd_pins axis_clock_converter/m_axis_aresetn]
  connect_bd_net -net dac0_clk_1 [get_bd_pins dac0_clk] [get_bd_pins axis_clock_converter/m_axis_aclk]
  connect_bd_net -net dac_irq_concat_dout [get_bd_pins dac_irq] [get_bd_pins dac_irq_concat/dout]
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins axi_dma_im/s_axi_lite_aclk] [get_bd_pins axi_dma_re/s_axi_lite_aclk] [get_bd_pins axi_interconnect/M01_ACLK] [get_bd_pins axi_interconnect/M02_ACLK] [get_bd_pins axi_interconnect/M03_ACLK] [get_bd_pins dac_source_switch/s_axi_ctrl_aclk]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins AXI4_Stream_Synchoni_0/ARESETN] [get_bd_pins axi_dma_im/axi_resetn] [get_bd_pins axi_dma_re/axi_resetn] [get_bd_pins axi_interconnect/M01_ARESETN] [get_bd_pins axi_interconnect/M02_ARESETN] [get_bd_pins axi_interconnect/M03_ARESETN] [get_bd_pins dac_source_switch/s_axi_ctrl_aresetn]
...
proc create_hier_cell_channel_20 { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net packet_generator_M_AXIS_IM [get_bd_intf_pins axi_dma_imag/S_AXIS_S2MM] [get_bd_intf_pins packet_generator/M_AXIS_IM]
  connect_bd_intf_net -intf_net packet_generator_M_AXIS_RE [get_bd_intf_pins axi_dma_real/S_AXIS_S2MM] [get_bd_intf_pins packet_generator/M_AXIS_RE]
  ...
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins m_axis_aresetn] [get_bd_pins axi_interconnect_hpm/M02_ARESETN] [get_bd_pins axi_interconnect_hps/ARESETN] [get_bd_pins axi_interconnect_hps/M00_ARESETN] [get_bd_pins axi_interconnect_hps/S00_ARESETN] [get_bd_pins axi_interconnect_hps/S01_ARESETN] [get_bd_pins packet_generator/aresetn]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins s_axi_aresetn] [get_bd_pins axi_dma_imag/axi_resetn] [get_bd_pins axi_dma_real/axi_resetn] [get_bd_pins axi_interconnect_hpm/ARESETN] [get_bd_pins axi_interconnect_hpm/M00_ARESETN] [get_bd_pins axi_interconnect_hpm/M01_ARESETN] [get_bd_pins axi_interconnect_hpm/S00_ARESETN]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins s_axi_aclk] [get_bd_pins axi_dma_imag/s_axi_lite_aclk] [get_bd_pins axi_dma_real/s_axi_lite_aclk] [get_bd_pins axi_interconnect_hpm/ACLK] [get_bd_pins axi_interconnect_hpm/M00_ACLK] [get_bd_pins axi_interconnect_hpm/M01_ACLK] [get_bd_pins axi_interconnect_hpm/S00_ACLK]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_pins m_axis_aclk] [get_bd_pins axi_dma_imag/m_axi_s2mm_aclk] [get_bd_pins axi_dma_real/m_axi_s2mm_aclk] [get_bd_pins axi_interconnect_hpm/M02_ACLK] [get_bd_pins axi_interconnect_hps/ACLK] [get_bd_pins axi_interconnect_hps/M00_ACLK] [get_bd_pins axi_interconnect_hps/S00_ACLK] [get_bd_pins axi_interconnect_hps/S01_ACLK] [get_bd_pins packet_generator/aclk]
...
proc create_hier_cell_transmitter { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 M00_AXIS_DAC_IM

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 M00_AXIS_DAC_RE

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M00_AXI_MM2S_IM

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M00_AXI_MM2S_RE

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 M10_AXIS

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 M10_AXIS_DAC_IM

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 M10_AXIS_DAC_RE

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M10_AXI_MM2S_IM

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M10_AXI_MM2S_RE

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 S00_AXIS_DAC_IM

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 S00_AXIS_DAC_RE

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 S10_AXIS_DAC_IM

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 S10_AXIS_DAC_RE
  ...
  create_bd_pin -dir I -type rst dac0_aresetn
  create_bd_pin -dir I -type clk dac0_clk
  create_bd_pin -dir I -type rst dac1_aresetn1
  create_bd_pin -dir I -type clk dac1_clk
  create_bd_pin -dir O -from 3 -to 0 dac_irq
  create_bd_pin -dir I -type clk m_axi_aclk
  create_bd_pin -dir I -type rst m_axi_aresetn
  create_bd_pin -dir I -type clk s_axi_aclk
  create_bd_pin -dir I -type rst s_axi_aresetn
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S00_AXIS_DAC_IM_1 [get_bd_intf_pins S00_AXIS_DAC_IM] [get_bd_intf_pins channel_00/S_AXIS_DAC_IM]
  connect_bd_intf_net -intf_net S00_AXIS_DAC_RE_1 [get_bd_intf_pins S00_AXIS_DAC_RE] [get_bd_intf_pins channel_00/S_AXIS_DAC_RE]
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins S_AXI] [get_bd_intf_pins axi_interconnect/S00_AXI]
  connect_bd_intf_net -intf_net S10_AXIS_DAC_IM_1 [get_bd_intf_pins S10_AXIS_DAC_IM] [get_bd_intf_pins channel_10/S_AXIS_DAC_IM]
  connect_bd_intf_net -intf_net S10_AXIS_DAC_RE_1 [get_bd_intf_pins S10_AXIS_DAC_RE] [get_bd_intf_pins channel_10/S_AXIS_DAC_RE]
  ...
  connect_bd_intf_net -intf_net channel_00_DAC0_M_AXI_MM2S [get_bd_intf_pins M00_AXI_MM2S_RE] [get_bd_intf_pins channel_00/M_AXI_MM2S_RE]
  connect_bd_intf_net -intf_net channel_00_M_AXIS [get_bd_intf_pins M00_AXIS] [get_bd_intf_pins channel_00/M_AXIS]
  connect_bd_intf_net -intf_net channel_00_M_AXIS_DAC_IM [get_bd_intf_pins M00_AXIS_DAC_IM] [get_bd_intf_pins channel_00/M_AXIS_DAC_IM]
  connect_bd_intf_net -intf_net channel_00_M_AXIS_DAC_RE [get_bd_intf_pins M00_AXIS_DAC_RE] [get_bd_intf_pins channel_00/M_AXIS_DAC_RE]
  connect_bd_intf_net -intf_net channel_00_M_AXI_MM2S_IM [get_bd_intf_pins M00_AXI_MM2S_IM] [get_bd_intf_pins channel_00/M_AXI_MM2S_IM]
  connect_bd_intf_net -intf_net channel_0_M_AXIS [get_bd_intf_pins M10_AXIS] [get_bd_intf_pins channel_10/M_AXIS]
  connect_bd_intf_net -intf_net channel_0_M_AXIS_DAC_IM [get_bd_intf_pins M10_AXIS_DAC_IM] [get_bd_intf_pins channel_10/M_AXIS_DAC_IM]
  connect_bd_intf_net -intf_net channel_0_M_AXIS_DAC_RE [get_bd_intf_pins M10_AXIS_DAC_RE] [get_bd_intf_pins channel_10/M_AXIS_DAC_RE]
  connect_bd_intf_net -intf_net channel_0_M_AXI_MM2S_RE [get_bd_intf_pins M10_AXI_MM2S_RE] [get_bd_intf_pins channel_10/M_AXI_MM2S_RE]
  connect_bd_intf_net -intf_net channel_10_M_AXI_MM2S_IM [get_bd_intf_pins M10_AXI_MM2S_IM] [get_bd_intf_pins channel_10/M_AXI_MM2S_IM]

  # Create port connections
  connect_bd_net -net M00_ACLK_1 [get_bd_pins m_axi_aclk] [get_bd_pins axi_interconnect/M00_ACLK] [get_bd_pins axi_interconnect/M01_ACLK] [get_bd_pins channel_00/m_axi_aclk] [get_bd_pins channel_10/m_axi_aclk]
  connect_bd_net -net M00_ARESETN_1 [get_bd_pins m_axi_aresetn] [get_bd_pins axi_interconnect/M00_ARESETN] [get_bd_pins axi_interconnect/M01_ARESETN] [get_bd_pins channel_00/m_axi_aresetn] [get_bd_pins channel_10/m_axi_aresetn]
  connect_bd_net -net channel_00_dac_irq [get_bd_pins channel_00/dac_irq] [get_bd_pins dac_irq_concat/In0]
  connect_bd_net -net channel_10_dout_1 [get_bd_pins channel_10/dac_irq] [get_bd_pins dac_irq_concat/In1]
  connect_bd_net -net dac0_aresetn_1 [get_bd_pins dac0_aresetn] [get_bd_pins channel_00/dac0_aresetn]
  connect_bd_net -net dac0_clk_1 [get_bd_pins dac0_clk] [get_bd_pins channel_00/dac0_clk]
  connect_bd_net -net dac1_aresetn1_1 [get_bd_pins dac1_aresetn1] [get_bd_pins channel_10/dac0_aresetn]
  connect_bd_net -net dac1_clk_1 [get_bd_pins dac1_clk] [get_bd_pins channel_10/dac0_clk]
  connect_bd_net -net dac_irq_concat_dout [get_bd_pins dac_irq] [get_bd_pins dac_irq_concat/dout]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins s_axi_aresetn] [get_bd_pins axi_interconnect/ARESETN] [get_bd_pins axi_interconnect/S00_ARESETN] [get_bd_pins channel_00/s_axi_aresetn] [get_bd_pins channel_10/s_axi_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins s_axi_aclk] [get_bd_pins axi_interconnect/ACLK] [get_bd_pins axi_interconnect/S00_ACLK] [get_bd_pins channel_00/s_axi_aclk] [get_bd_pins channel_10/s_axi_aclk]
...
proc create_hier_cell_receiver { parentCell nameHier } {
  ...
  connect_bd_net -net proc_sys_reset_adc0_peripheral_aresetn [get_bd_pins s_axis_aresetn] [get_bd_pins channel_00/s_axis_aresetn]
  connect_bd_net -net proc_sys_reset_adc2_peripheral_aresetn [get_bd_pins s_axis_aresetn1] [get_bd_pins channel_20/s_axis_aresetn]
  connect_bd_net -net rfdc_clk_adc0 [get_bd_pins clk_adc0] [get_bd_pins channel_00/s_axis_aclk]
  connect_bd_net -net rfdc_clk_adc2 [get_bd_pins clk_adc2] [get_bd_pins channel_20/s_axis_aclk]
...
proc create_hier_cell_radio { parentCell nameHier } {
  ...
  # Create interface pins
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 M00_AXIS_ADC_IM

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 M00_AXIS_ADC_RE
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 M20_AXIS_ADC_IM

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 M20_AXIS_ADC_RE

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M_AXI_ADC

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 S00_AXIS_ADC_IM

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 S00_AXIS_ADC_RE
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 S20_AXIS_ADC_IM

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 S20_AXIS_ADC_RE

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 S_AXI

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 adc0_clk

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:rfdc_nco_pins_rtl:1.0 adc0_nco

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:rfdc_rts_pins_rtl:1.0 adc0_rts

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 adc2_clk

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:rfdc_nco_pins_rtl:1.0 adc2_nco

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:rfdc_rts_pins_rtl:1.0 adc2_rts

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 dac0_clk

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:rfdc_nco_pins_rtl:1.0 dac0_nco

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:rfdc_rts_pins_rtl:1.0 dac0_rts

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 dac1_clk

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:rfdc_nco_pins_rtl:1.0 dac1_nco

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:rfdc_rts_pins_rtl:1.0 dac1_rts
  ...
  # Create pins
  create_bd_pin -dir O -from 8 -to 0 dout_0
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins M20_AXIS_ADC_IM] [get_bd_intf_pins axis_clock_converter_3/M_AXIS]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins M20_AXIS_ADC_RE] [get_bd_intf_pins axis_clock_converter_2/M_AXIS]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins M00_AXIS_ADC_IM] [get_bd_intf_pins axis_clock_converter_1/M_AXIS]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins M00_AXIS_ADC_RE] [get_bd_intf_pins axis_clock_converter_0/M_AXIS]
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins S00_AXIS_ADC_IM] [get_bd_intf_pins receiver/S_AXIS_ADC_00_IM]
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins S00_AXIS_ADC_RE] [get_bd_intf_pins receiver/S_AXIS_ADC_00_RE]
  connect_bd_intf_net -intf_net Conn7 [get_bd_intf_pins S20_AXIS_ADC_IM] [get_bd_intf_pins receiver/S_AXIS_ADC_20_IM]
  connect_bd_intf_net -intf_net Conn8 [get_bd_intf_pins S20_AXIS_ADC_RE] [get_bd_intf_pins receiver/S_AXIS_ADC_20_RE]
  connect_bd_intf_net -intf_net Conn9 [get_bd_intf_pins adc0_nco] [get_bd_intf_pins rfdc/adc0_nco]
  connect_bd_intf_net -intf_net Conn10 [get_bd_intf_pins adc2_nco] [get_bd_intf_pins rfdc/adc2_nco]
  connect_bd_intf_net -intf_net Conn11 [get_bd_intf_pins dac0_nco] [get_bd_intf_pins rfdc/dac0_nco]
  connect_bd_intf_net -intf_net Conn12 [get_bd_intf_pins dac1_nco] [get_bd_intf_pins rfdc/dac1_nco]
  connect_bd_intf_net -intf_net Conn13 [get_bd_intf_pins M00_AXIS_DAC_RE] [get_bd_intf_pins transmitter/M00_AXIS_DAC_RE]
  connect_bd_intf_net -intf_net Conn14 [get_bd_intf_pins M00_AXI_MM2S_RE] [get_bd_intf_pins transmitter/M00_AXI_MM2S_RE]
  connect_bd_intf_net -intf_net Conn15 [get_bd_intf_pins M10_AXI_MM2S_RE] [get_bd_intf_pins transmitter/M10_AXI_MM2S_RE]
  connect_bd_intf_net -intf_net Conn16 [get_bd_intf_pins M00_AXIS_DAC_IM] [get_bd_intf_pins transmitter/M00_AXIS_DAC_IM]
  connect_bd_intf_net -intf_net Conn17 [get_bd_intf_pins M10_AXIS_DAC_RE] [get_bd_intf_pins transmitter/M10_AXIS_DAC_RE]
  connect_bd_intf_net -intf_net Conn18 [get_bd_intf_pins M10_AXIS_DAC_IM] [get_bd_intf_pins transmitter/M10_AXIS_DAC_IM]
  connect_bd_intf_net -intf_net Conn19 [get_bd_intf_pins dac0_rts] [get_bd_intf_pins rfdc/dac0_rts]
  connect_bd_intf_net -intf_net Conn20 [get_bd_intf_pins dac1_rts] [get_bd_intf_pins rfdc/dac1_rts]
  connect_bd_intf_net -intf_net Conn21 [get_bd_intf_pins adc0_rts] [get_bd_intf_pins rfdc/adc0_rts]
  connect_bd_intf_net -intf_net Conn22 [get_bd_intf_pins adc2_rts] [get_bd_intf_pins rfdc/adc2_rts]
  connect_bd_intf_net -intf_net S00_AXIS_DAC_IM_1 [get_bd_intf_pins S00_AXIS_DAC_IM] [get_bd_intf_pins transmitter/S00_AXIS_DAC_IM]
  connect_bd_intf_net -intf_net S00_AXIS_DAC_RE_1 [get_bd_intf_pins S00_AXIS_DAC_RE] [get_bd_intf_pins transmitter/S00_AXIS_DAC_RE]
  connect_bd_intf_net -intf_net S10_AXIS_DAC_IM_1 [get_bd_intf_pins S10_AXIS_DAC_IM] [get_bd_intf_pins transmitter/S10_AXIS_DAC_IM]
  connect_bd_intf_net -intf_net S10_AXIS_DAC_RE_1 [get_bd_intf_pins S10_AXIS_DAC_RE] [get_bd_intf_pins transmitter/S10_AXIS_DAC_RE]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_hps1_M00_AXI [get_bd_intf_pins M_AXI_ADC] [get_bd_intf_pins receiver/M_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_ps_M00_AXI [get_bd_intf_pins axi_interconnect_ps/M00_AXI] [get_bd_intf_pins receiver/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_ps_M01_AXI [get_bd_intf_pins axi_interconnect_ps/M01_AXI] [get_bd_intf_pins rfdc/s_axi]
  connect_bd_intf_net -intf_net axi_interconnect_ps_M02_AXI [get_bd_intf_pins axi_interconnect_ps/M02_AXI] [get_bd_intf_pins transmitter/S_AXI]
  ...
  connect_bd_intf_net -intf_net rfdc_m00_axis [get_bd_intf_pins axis_clock_converter_0/S_AXIS] [get_bd_intf_pins rfdc/m00_axis]
  connect_bd_intf_net -intf_net rfdc_m01_axis [get_bd_intf_pins axis_clock_converter_1/S_AXIS] [get_bd_intf_pins rfdc/m01_axis]
  connect_bd_intf_net -intf_net rfdc_m20_axis [get_bd_intf_pins axis_clock_converter_2/S_AXIS] [get_bd_intf_pins rfdc/m20_axis]
  connect_bd_intf_net -intf_net rfdc_m21_axis [get_bd_intf_pins axis_clock_converter_3/S_AXIS] [get_bd_intf_pins rfdc/m21_axis]
  ...
  connect_bd_intf_net -intf_net transmitter_M00_AXI_MM2S_IM [get_bd_intf_pins M00_AXI_MM2S_IM] [get_bd_intf_pins transmitter/M00_AXI_MM2S_IM]
  connect_bd_intf_net -intf_net transmitter_M10_AXI_MM2S_IM [get_bd_intf_pins M10_AXI_MM2S_IM] [get_bd_intf_pins transmitter/M10_AXI_MM2S_IM]
  connect_bd_intf_net -intf_net transmitter_M_AXIS [get_bd_intf_pins rfdc/s00_axis] [get_bd_intf_pins transmitter/M00_AXIS]
  connect_bd_intf_net -intf_net transmitter_M_AXIS1 [get_bd_intf_pins rfdc/s10_axis] [get_bd_intf_pins transmitter/M10_AXIS]
  ...
  # Create port connections
  connect_bd_net -net M01_ACLK_1 [get_bd_pins proc_sys_reset_dac1/slowest_sync_clk] [get_bd_pins rfdc/clk_dac1] [get_bd_pins rfdc/s1_axis_aclk] [get_bd_pins transmitter/dac1_clk]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins m_axi_aresetn] [get_bd_pins axis_clock_converter_0/m_axis_aresetn] [get_bd_pins axis_clock_converter_1/m_axis_aresetn] [get_bd_pins axis_clock_converter_2/m_axis_aresetn] [get_bd_pins axis_clock_converter_3/m_axis_aresetn] [get_bd_pins receiver/m_axis_aresetn] [get_bd_pins transmitter/m_axi_aresetn]
  connect_bd_net -net proc_sys_reset_adc0_peripheral_aresetn [get_bd_pins axis_clock_converter_0/s_axis_aresetn] [get_bd_pins axis_clock_converter_1/s_axis_aresetn] [get_bd_pins proc_sys_reset_adc0/peripheral_aresetn] [get_bd_pins receiver/s_axis_aresetn] [get_bd_pins rfdc/m0_axis_aresetn]
  connect_bd_net -net proc_sys_reset_adc2_peripheral_aresetn [get_bd_pins axis_clock_converter_2/s_axis_aresetn] [get_bd_pins axis_clock_converter_3/s_axis_aresetn] [get_bd_pins proc_sys_reset_adc2/peripheral_aresetn] [get_bd_pins receiver/s_axis_aresetn1] [get_bd_pins rfdc/m2_axis_aresetn]
  connect_bd_net -net proc_sys_reset_dac0_peripheral_aresetn [get_bd_pins proc_sys_reset_dac0/peripheral_aresetn] [get_bd_pins rfdc/s0_axis_aresetn] [get_bd_pins transmitter/dac0_aresetn]
  connect_bd_net -net proc_sys_reset_dac1_peripheral_aresetn [get_bd_pins proc_sys_reset_dac1/peripheral_aresetn] [get_bd_pins rfdc/s1_axis_aresetn] [get_bd_pins transmitter/dac1_aresetn1]
  connect_bd_net -net receiver_irq [get_bd_pins receiver/irq] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net rfdc_clk_adc0 [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins axis_clock_converter_1/s_axis_aclk] [get_bd_pins proc_sys_reset_adc0/slowest_sync_clk] [get_bd_pins rfdc/clk_adc0] [get_bd_pins rfdc/m0_axis_aclk]
  connect_bd_net -net rfdc_clk_adc2 [get_bd_pins axis_clock_converter_2/s_axis_aclk] [get_bd_pins axis_clock_converter_3/s_axis_aclk] [get_bd_pins proc_sys_reset_adc2/slowest_sync_clk] [get_bd_pins receiver/clk_adc2] [get_bd_pins rfdc/clk_adc2] [get_bd_pins rfdc/m2_axis_aclk]
  connect_bd_net -net rfdc_clk_dac0 [get_bd_pins proc_sys_reset_dac0/slowest_sync_clk] [get_bd_pins rfdc/clk_dac0] [get_bd_pins rfdc/s0_axis_aclk] [get_bd_pins transmitter/dac0_clk]
  connect_bd_net -net rfdc_irq [get_bd_pins rfdc/irq] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins s_axi_aresetn] [get_bd_pins axi_interconnect_ps/ARESETN] [get_bd_pins axi_interconnect_ps/M00_ARESETN] [get_bd_pins axi_interconnect_ps/M01_ARESETN] [get_bd_pins axi_interconnect_ps/M02_ARESETN] [get_bd_pins axi_interconnect_ps/M03_ARESETN] [get_bd_pins axi_interconnect_ps/S00_ARESETN] [get_bd_pins receiver/s_axi_aresetn] [get_bd_pins rfdc/s_axi_aresetn] [get_bd_pins transmitter/s_axi_aresetn]
  connect_bd_net -net transmitter_dac_irq [get_bd_pins transmitter/dac_irq] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins dout_0] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins s_axi_aclk] [get_bd_pins axi_interconnect_ps/ACLK] [get_bd_pins axi_interconnect_ps/M00_ACLK] [get_bd_pins axi_interconnect_ps/M01_ACLK] [get_bd_pins axi_interconnect_ps/M02_ACLK] [get_bd_pins axi_interconnect_ps/M03_ACLK] [get_bd_pins axi_interconnect_ps/S00_ACLK] [get_bd_pins receiver/s_axi_aclk] [get_bd_pins rfdc/s_axi_aclk] [get_bd_pins transmitter/s_axi_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_pins m_axi_aclk] [get_bd_pins axis_clock_converter_0/m_axis_aclk] [get_bd_pins axis_clock_converter_1/m_axis_aclk] [get_bd_pins axis_clock_converter_2/m_axis_aclk] [get_bd_pins axis_clock_converter_3/m_axis_aclk] [get_bd_pins receiver/clk_adc0] [get_bd_pins receiver/m_axis_aclk] [get_bd_pins transmitter/m_axi_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins ext_reset] [get_bd_pins proc_sys_reset_adc0/ext_reset_in] [get_bd_pins proc_sys_reset_adc2/ext_reset_in] [get_bd_pins proc_sys_reset_dac0/ext_reset_in] [get_bd_pins proc_sys_reset_dac1/ext_reset_in]
...
proc create_hier_cell_ddr4 { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins S00_AXI] [get_bd_intf_pins axi_hpm0_fpd/S00_AXI]
  ...
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins S00_ARESETN] [get_bd_pins axi_hpm0_fpd/ARESETN] [get_bd_pins axi_hpm0_fpd/S00_ARESETN]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins resetn] [get_bd_pins binary_latch_counter_0/resetn]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins clk] [get_bd_pins binary_latch_counter_0/clk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_pins S00_ACLK] [get_bd_pins axi_hpm0_fpd/ACLK] [get_bd_pins axi_hpm0_fpd/S00_ACLK]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_clk_conv_0, and set properties
  set axi_clk_conv_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_clock_converter:2.1 axi_clk_conv_0 ]
  set_property -dict [ list \
   CONFIG.ACLK_ASYNC {1} \
...
MIO#USB0 Reset#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#I2C 0#I2C\
0#I2C 1#I2C 1#UART 0#UART 0#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0\
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;97FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins ddr4/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]
  ...
  connect_bd_intf_net -intf_net axi_hpm1_fpd_M02_AXI [get_bd_intf_pins axi_clk_conv_0/S_AXI] [get_bd_intf_pins axi_hpm1_fpd/M02_AXI]
  ...
  connect_bd_intf_net -intf_net radio_M00_AXI_MM2S_IM [get_bd_intf_pins radio/M00_AXI_MM2S_IM] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD]
  connect_bd_intf_net -intf_net radio_M10_AXI_MM2S_IM [get_bd_intf_pins radio/M10_AXI_MM2S_IM] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP1_FPD]
  connect_bd_intf_net -intf_net radio_M_AXI [get_bd_intf_pins radio/M_AXI_ADC] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP2_FPD]
  connect_bd_intf_net -intf_net radio_M_AXI_MM2S_0 [get_bd_intf_pins radio/M00_AXI_MM2S_RE] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HPC0_FPD]
  connect_bd_intf_net -intf_net radio_M_AXI_MM2S_1 [get_bd_intf_pins radio/M10_AXI_MM2S_RE] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HPC1_FPD]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_clk_conv_0/s_axi_aclk] [get_bd_pins axi_hpm0_lpd/ACLK] [get_bd_pins axi_hpm0_lpd/M00_ACLK] [get_bd_pins axi_hpm0_lpd/M01_ACLK] [get_bd_pins axi_hpm0_lpd/M02_ACLK] [get_bd_pins axi_hpm0_lpd/M03_ACLK] [get_bd_pins axi_hpm0_lpd/M04_ACLK] [get_bd_pins axi_hpm0_lpd/M05_ACLK] [get_bd_pins axi_hpm0_lpd/M06_ACLK] [get_bd_pins axi_hpm0_lpd/M07_ACLK] [get_bd_pins axi_hpm0_lpd/M08_ACLK] [get_bd_pins axi_hpm0_lpd/M09_ACLK] [get_bd_pins axi_hpm0_lpd/M10_ACLK] [get_bd_pins axi_hpm0_lpd/S00_ACLK] [get_bd_pins axi_hpm1_fpd/ACLK] [get_bd_pins axi_hpm1_fpd/M00_ACLK] [get_bd_pins axi_hpm1_fpd/M01_ACLK] [get_bd_pins axi_hpm1_fpd/M02_ACLK] [get_bd_pins axi_hpm1_fpd/S00_ACLK] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins ddr4/clk] [get_bd_pins pin_control/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins radio/s_axi_aclk] [get_bd_pins system_management_wiz_0/s_axi_aclk] [get_bd_pins syzygy_std0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_pins axi_clk_conv_0/m_axi_aclk] [get_bd_pins ddr4/S00_ACLK] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins radio/m_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk1] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp2_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc1_fpd_aclk]
  ...
  assign_bd_address -offset 0xB00F0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs radio/transmitter/channel_10/amplitude_controller/S_AXI/S_AXI_reg] -force
  assign_bd_address -offset 0xB00C0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs radio/transmitter/channel_00/axi_dma_re/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0xB00E0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs radio/transmitter/channel_00/axi_dma_im/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0xB0100000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs radio/transmitter/channel_10/axi_dma_im/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0xB0110000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs radio/transmitter/channel_10/axi_dma_re/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0xB00D0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs radio/transmitter/channel_00/dac_source_switch/S_AXI_CTRL/Reg] -force
  assign_bd_address -offset 0xB0120000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs radio/transmitter/channel_10/dac_source_switch/S_AXI_CTRL/Reg] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces radio/transmitter/channel_00/axi_dma_im/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces radio/transmitter/channel_00/axi_dma_re/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces radio/transmitter/channel_10/axi_dma_im/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces radio/transmitter/channel_10/axi_dma_re/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_DDR_LOW] -force
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces radio/transmitter/channel_00/axi_dma_im/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces radio/transmitter/channel_00/axi_dma_im/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces radio/transmitter/channel_00/axi_dma_re/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces radio/transmitter/channel_00/axi_dma_re/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_LPS_OCM]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces radio/transmitter/channel_10/axi_dma_im/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces radio/transmitter/channel_10/axi_dma_im/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces radio/transmitter/channel_10/axi_dma_re/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces radio/transmitter/channel_10/axi_dma_re/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_LPS_OCM]
