...
#
# Generated by Vivado on Fri Nov 12 17:09:24 PST 2021
...
proc checkRequiredFiles { origin_dir} {
  ...
  set paths [list \
   [file normalize "$origin_dir/../../../RFSoC2x2-BGS/board/ip/AXI4_Stream_Data_Splitter_1.0"] \
   [file normalize "$origin_dir/../../../RFSoC2x2-BGS/board/ip/axi4-stream-split/AXI4-Stream_Data_Splitter_1.0"] \
   [file normalize "$origin_dir/../../../RFSoC2x2-PYNQ/board/ip"] \
  ]
  foreach ipath $paths {
...
set orig_proj_dir "[file normalize "$origin_dir/../../../RFSoC2x2-BGS/board/RFSoC2x2/base_matlab"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../RFSoC2x2-BGS/board/ip/AXI4_Stream_Data_Splitter_1.0"] [file normalize "$origin_dir/../../../RFSoC2x2-BGS/board/ip/axi4-stream-split/AXI4-Stream_Data_Splitter_1.0"] [file normalize "$origin_dir/../../../RFSoC2x2-PYNQ/board/ip"]" $obj
...
set file "[file normalize ${origin_dir}/../../../RFSoC2x2-BGS/board/RFSoC2x2/base_matlab/base.srcs/constrs_1/imports/constraints/base.xdc]"
...
preplace port ddr4_pl -pg 1 -lvl 9 -x 4500 -y -110 -defaultsOSRD
preplace port sys_clk_ddr4 -pg 1 -lvl 0 -x -320 -y 60 -defaultsOSRD
preplace port sysref_in -pg 1 -lvl 0 -x -320 -y 220 -defaultsOSRD
preplace port syzygy_std0 -pg 1 -lvl 9 -x 4500 -y 500 -defaultsOSRD
...
preplace port dp_aux_data_out -pg 1 -lvl 9 -x 4500 -y 480 -defaultsOSRD
preplace port dp_hot_plug_detect -pg 1 -lvl 0 -x -320 -y 1230 -defaultsOSRD
preplace portBus dp_aux_data_oe -pg 1 -lvl 9 -x 4500 -y 1500 -defaultsOSRD
preplace portBus lmk_reset -pg 1 -lvl 9 -x 4500 -y 680 -defaultsOSRD
preplace portBus syzygy_vio_en -pg 1 -lvl 9 -x 4500 -y 770 -defaultsOSRD
preplace inst pin0_lmk_reset -pg 1 -lvl 8 -x 4322 -y 670 -defaultsOSRD
preplace inst pin1_syzygy_vio_en -pg 1 -lvl 8 -x 4322 -y 770 -defaultsOSRD
...
preplace inst dp_aux_data_oe_inv -pg 1 -lvl 8 -x 4322 -y 1500 -defaultsOSRD
preplace inst pin_control -pg 1 -lvl 3 -x 740 -y 890 -defaultsOSRD
preplace inst system_management_wiz_0 -pg 1 -lvl 7 -x 2660 -y 790 -defaultsOSRD
preplace inst syzygy_std0 -pg 1 -lvl 8 -x 4322 -y 550 -defaultsOSRD
...
preplace inst ddr4 -pg 1 -lvl 7 -x 2660 -y -110 -defaultsOSRD
preplace inst radio -pg 1 -lvl 7 -x 2660 -y 320 -defaultsOSRD
preplace inst axi_clk_conv_0 -pg 1 -lvl 7 -x 2660 -y 1190 -defaultsOSRD
...
preplace netloc pin0_lmk_reset_Dout 1 8 1 4480J 670n
preplace netloc pin2_syzygy_vio_en_Dout 1 8 1 NJ 770
preplace netloc pin_control_gpio_io_o 1 3 5 NJ 900 NJ 900 NJ 900 2250J 970 2850J
...
preplace netloc system_management_wiz_0_ip2intc_irpt 1 1 7 130 90 NJ 90 NJ 90 NJ 90 NJ 90 NJ 90 2840
...
preplace netloc zynq_ultra_ps_e_0_dp_aux_data_out 1 5 4 1900J 100 NJ 100 NJ 100 4480J
...
preplace netloc concat_irq_dout 1 1 7 130 1320 N 1320 890 1330 N 1330 N 1330 N 1330 2830
...
preplace netloc syzygy_std0_GPIO 1 8 1 4480J 500n
...
preplace netloc axi_interconnect_1_M00_AXI1 1 4 4 1130 80 N 80 N 80 2850
...
levelinfo -pg 1 -320 -70 340 740 1030 1520 2100 2660 4322 4500
pagesize -pg 1 -db -bbox -sgen -510 -5620 4700 3270
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse base.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../../RFSoC2x2-BGS/board/RFSoC2x2/base_matlab/base.srcs/sources_1/bd/base/hdl/base_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse base.bd] -top]
  add_files -norecurse -fileset sources_1 $wrapper_path
}
